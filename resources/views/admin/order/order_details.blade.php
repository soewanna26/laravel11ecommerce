                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{ $order->deliveryed_date ? \Carbon\Carbon::parse($order->deliveryed_date)->format('d/m/Y') : '-' }}</td>
                            <th>Canceled Date</th>
                            <td>{{ $order->canceled_date ? \Carbon\Carbon::parse($order->canceled_date)->format('d/m/Y') : '-' }}</td>
                        </tr>
                        <tr>
                            <th>Order Status</th>
                            <td colspan="5">
                        ...
                        <tbody>
                            @foreach ($orderItems as $orderItem)
                                <tr>
                                    ...
                                    <td class="pname">
                                        <div class="image">
                                            <img src="{{ asset('storage/productImage/productThumbnails/' . $orderItem->product->image) }}"
                                                alt="" class="image">
                                        </div>
                                        <div class="name">
