                    ...
                    <div class="cart-table__wrapper">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="shopping-cart__product-item">
                                                <img loading="lazy"
                                                    src="{{ asset('storage/productImage/productThumbnails/' . $item->model->image) }}"
                        ...
                        <div class="cart-table-footer">
                            @if (!Session::has('coupon'))
                                <form action="{{ route('cart.apply.coupon') }}" class="position-relative bg-body"
                                    method="POST">
                                    @csrf
                            ...
                            @else
                                <form action="{{ route('cart.remove.coupon.code') }}" class="position-relative bg-body"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <input class="form-control" type="text" name="coupon_code" placeholder="Coupon Code"
