                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-striped table-transaction">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $order->deliveryed_date ? \Carbon\Carbon::parse($order->deliveryed_date)->format('d/m/Y') : '-' }}
                                    </td>
                                    <th>Canceled Date</th>
                                    <td>{{ $order->canceled_date ? \Carbon\Carbon::parse($order->canceled_date)->format('d/m/Y') : '-' }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>Order Status</th>
